...
struct Browser final : public glow::WebView {
    ...
    auto web_message_received_handler(ICoreWebView2* sender,
        ...
        -> ::HRESULT override;
    auto source_changed_handler(ICoreWebView2* sender,
                                ICoreWebView2SourceChangedEventArgs* args) -> ::HRESULT override;
    auto document_title_changed_handler(ICoreWebView2* sender,
                                        IUnknown* args) -> ::HRESULT override;
    ...
    auto move_focus_requested_handler(ICoreWebView2Controller* sender,
        ...
        -> ::HRESULT override;
    auto zoom_factor_changed_handler(ICoreWebView2Controller* sender,
                                     IUnknown* args) -> ::HRESULT override;
